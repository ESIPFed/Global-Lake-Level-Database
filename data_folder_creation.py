def data_folder_creation(df):
    ...
    for ids, name in zip(df['Lake_#'], df['Lake_Name']):
        if ids == '0012' or ids == '0021':

            lake_folder = data_folder / '{}_Lake_{}'.format(ids, name)
            ...
            header_information_path = lake_folder / '{}_{}_header_information.txt'.format(ids, name)
            ...
            df_path = lake_folder / '{}_{}_water_level_data.csv'.format(ids, name)
            print('writing data frame to..... ', df_path)
